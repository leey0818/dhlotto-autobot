...
export const URL_ROUND_INFO = 'https://dhlottery.co.kr/common.do?method=main';
...
export const ERROR_COOKIE_NOT_FOUND = '쿠키가 정상적으로 세팅되지 않았습니다.';
export const ERROR_LOGIN_FAILED = '로그인에 실패했습니다.';
export const ERROR_BUY_FAILED = '구매에 실패했습니다.';
export const ERROR_EMPTY_RESULT = 'result message is empty';
